...
function CommandInput({ className, isLoading = false, ...props }: React.ComponentProps<typeof CommandPrimitive.Input> & { isLoading?: boolean }) {
  return (
